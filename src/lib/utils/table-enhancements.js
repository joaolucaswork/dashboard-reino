...
export const financialBadgeConfigs = {
  consolidado: {
    ...
    getBadge: (row) => {
      ...
      } else if (assetName.includes('debênture') || assetName.includes('debenture')) {
  ...
  movimentacoes: {
    ...
    getBadge: (row) => {
      ...
      } else if (operation.includes('aplicação') || operation.includes('aplicacao')) {
 ...
 */
export function exportToExcel(data, columns, filename = 'dados-financeiros.xlsx') {
...
export const defaultColumnVisibility = {
  ...
  relatorio: {
    col1: true,  // Instituição
    col2: true,  // Tipo de Ativo
    col3: true,  // Ativo
    col4: true,  // Quantidade
    col5: true,  // Valor Atual
    col6: true   // % da Carteira
  },
  movimentacoes: {
    col1: true,  // Data
